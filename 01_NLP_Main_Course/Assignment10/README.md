...
![](http://latex.codecogs.com/gif.latex?h_{y=y_0,{MAP}}\\=\arg\max_{h\in{H}}P(y=y_0|a_1,a_2,a_3,...)\newline=\arg\max_{h\in{H}}\frac{P(a_1,a_2,a_3,...|y=y_0)\cdot{P(y=y_0)}}{P(a_1,a_2,...)}\newline=\arg\max_{h\in{H}}{P(a_1,a_2,a_3,...|y=y_0)\cdot{P}(y=y_0)}\newline=\arg\max_{h\in{H}}{P(a_1|y_0)\cdot{P(a_2|y_0)}\cdot{P(a_3|y_0)}\cdots{P(y=y_0)}}) (According to "Naive"hypothesis)
